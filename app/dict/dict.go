...
<b>6.</b> Выберите клиента (нажав на кнопку). Бот пришлет небольшую информацию о клиенте и кнопку для перехода в личную переписку`
	...
	dict["1 day"] = "До начала активности на которую вы подписались осталось меньше суток! Вы все еще планируете поучавствовать?"
	dict["2 hours"] = "До начала активности на которую вы подписались осталось меньше двух часов! Вы все еще планируете поучавствовать?"
